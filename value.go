...
type value interface {
	...
	// nativeFunction - value generated by a native function is tracked.
	nativeFunction() *NativeFunction
	nativeFunctionArgs() []interface{}
	setNativeFunction(function *NativeFunction, args []interface{})
	generatedByNativeFn() bool
...
type valueBase struct {
	...
	nativeFnArgs []interface{}
}

func (v *valueBase) aValue() {}

func (v *valueBase) nativeFunction() *NativeFunction {
	return v.nativeFn
}

func (v *valueBase) setNativeFunction(fn *NativeFunction, args []interface{}) {
	v.nativeFn = fn
	v.nativeFnArgs = args
}

func (v *valueBase) nativeFunctionArgs() []interface{} {
	return v.nativeFnArgs
}

func (v *valueBase) generatedByNativeFn() bool {
